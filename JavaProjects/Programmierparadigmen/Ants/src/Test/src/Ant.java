    ...
    import static src.Parameters.BASE_PROBABILITY;
    import static src.Parameters.SCENT_THRESHOLD_SUCHE;
    ...
    public class Ant {
        ...
        public void setHome(AntHill home) {
            this.home = home;
        }
        ...
        private Position getPositionWithLowestEuclideanDistance() {
            ...
            return positions.stream()
                    .min(Comparator.comparingDouble(pos -> home.getEuclideanDistance(pos)))
                    .orElse(null);
        }
        ...
        private int getNextDirIdx(Field field, boolean invertProbabilities) {
            ...
            for (int i : possibleDirIdxs) {
                ...
                if (field.getScentTrail(scentPos) > SCENT_THRESHOLD_SUCHE && this.state == State.ERKUNDUNG) {
