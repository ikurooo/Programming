...
public class LayeredRasterRGBA {
    ...
    private RasterRGBA rasterRGBA;

    private RasterRGBA activeLayer;
    private int activeIndex;

    private LinkedListRasterRGBA linkedList;
    ...
    public LayeredRasterRGBA(int width, int height) {
        ...
        this.rasterRGBA = new RasterRGBA(width, height);
        this.width = width;
        this.height = height;
        this.rasterRGBA.clear(new Color(0,0,0,255));

        this.linkedList = new LinkedListRasterRGBA();
        this.activeLayer = rasterRGBA;
        this.linkedList.addFirst(rasterRGBA);
        this.activeIndex = 0;
    }
    ...
    public void newLayer() {
        ...
        this.linkedList.addLast(newRasterRGBA);
    ...
    public void setActiveLayer(int i) {
        ...
        this.activeLayer = this.linkedList.get(i);
        this.activeIndex = i;
    }
    ...
    public void removeLayer(int i) {
        if(i == 0){
            ...
            this.activeIndex = this.linkedList.size-1;
            this.activeLayer = this.linkedList.getLast();
    ...
    public Color getPixelColor(int x, int y) {
        ...
        Color result = linkedList.getFirst().getPixelColor(x,y);

        if(this.numberOfLayers() == 1){
            return result;
        }

        for(doubleLinkedList n = this.linkedList.head;  n.getNext() != null; n = n.getNext()){
    ...
    public RasterRGBA asRasterRGBA() {
        ...
        RasterRGBA result = this.linkedList.getFirst();
    ...
    public void crop(int width, int height) {
        ...
        for(doubleLinkedList n = this.linkedList.head;  n!= null; n = n.getNext()){
