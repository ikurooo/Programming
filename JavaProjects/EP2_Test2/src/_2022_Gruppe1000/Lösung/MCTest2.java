package _2022_Gruppe1000.Lösung;// Bitte beantworten Sie die Multiple-Choice-Fragen (maximal 25 Punkte, 1 Punkt pro 'Choice').
    ...
    public static void main(String[] args) {
        checkAndPrint(
                ...
                new Question(
                        ...
                        new Choice(true, "Vorbedingung: a ist aufsteigend sortiert.                                          (1A)"),
                        new Choice(false, "Nachbedingung: Halbiert die Länge von a.                                           (1B)"),
                        new Choice(false, "Nachbedingung: a != null                                                           (1C)"),
                        new Choice(true, "Nachbedingung: Wirft eine Exception wenn a.length == 0.                            (1D)"),
                ...
                new Question(
                        ...
                        new Choice(true, "Bäume verwenden wir meist nur wo andere Datenstrukturen nicht passen.              (2C)"),
                        new Choice(true, "Ein AVL-Baum ist nicht immer effizienter als ein einfacher Suchbaum.               (2D)"),
                        new Choice(true, "Arrays sind sehr effizient wenn normale Arrayzugriffe ausreichen.                  (2E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(true, "Ausnahmen vom Typ RuntimeException sind überprüft (checked).                       (4A)"),
                        ...
                        new Choice(true, "Das Ergebnis von getMessage() soll die Fehlerart konkretisieren.                   (4D)"),
                        new Choice(true, "Nicht abgefangene Ausnahmen beenden das Programm mit einem Stack-Trace.            (4E)")
                ),
                ...
                new Question(
                        ...
                        new Choice(true, "Kommentare sollen vor allem die Innensicht darstellen.                             (5C)"),
                        new Choice(true, "Invarianten stehen hauptsächlich vor Methodenköpfen.                               (5D)"),
                        new Choice(true, "Besonders gute Programmstellen brauchen nicht viele Kommentare.                    (5E)")
                )
        );
    }
