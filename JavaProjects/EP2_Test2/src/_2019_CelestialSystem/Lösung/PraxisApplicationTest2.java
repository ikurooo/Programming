...
public class PraxisApplicationTest2 {
    ...
    public static void main(String[] args) {
        ...
        //Keine ahnung wie das sonst gehen soll wenn man nicht auf BodyIterable oder BinaryCelestialSystem castet
        for (CelestialBody b: (BodyIterable) solarSystem) {
...
//Keine ahnung wie das sonst gehen soll wenn man nicht auf BodyIterable oder BinaryCelestialSystem castet
        for (CelestialBody b:(BodyIterable) earthSystem) {
            System.out.println(b);
        }
        // Earth
        // Moon
