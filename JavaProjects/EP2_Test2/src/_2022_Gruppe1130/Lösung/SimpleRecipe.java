...
public class SimpleRecipe implements Recipe {
    ...
    public void put(Ingredient ingredient, int grams) {
        ...
        if(map.containsKey(ingredient)) {
            Integer integer = map.get(ingredient);
            int x = integer.intValue()+grams;
            map.put(ingredient, x);
        }
        else map.put(ingredient, grams);
    }
    ...
    public IngredientIterator iterator() {
        ...
        Iterator<Ingredient> iterator = set.iterator();
        return new IngredientIterator() {

            @Override
            public Ingredient next() {
                if(!hasNext()) throw new NoSuchElementException("no next ingrediant!");
    ...
    public String toString() {
        ...
        for (Ingredient i:this) {
            ret+= i.toString()+"="+ map.get(i).intValue()+", ";
        }
